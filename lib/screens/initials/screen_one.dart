...
class _ScreenOneState extends State<ScreenOne> {
  ...
  //     // Locked: a wrong answer must be resolved with the button, never by
  //     // swiping the sheet away or tapping outside it.
  //     isDismissible: false,
  //     enableDrag: false,
  //     builder: (_) {
  ...
  //                       if (isCorrect) {
  //                         // Only a correct answer is allowed to advance the
  //                         // activity — this screen never hands a wrong
  //                         // answer up to the parent.
  //                         widget.onTaskComplete?.call(true);
  //                       } else {
  //                         // "Try Again" means exactly that: stay on this
  //                         // task, clear the pick, let them retry.
  //                         setState(() => selectedOption = '');
  //                       }
  //                     },
